...
namespace Real_Estate.Core.Application.Features.Improvements.Queries.GetAllImprovements
{
    public class GetAllImprovementsQuery : IRequest<IEnumerable<ImprovementsViewModel>>
    {
        public class GetAllCategoriesQueryHandler : IRequestHandler<GetAllImprovementsQuery,
