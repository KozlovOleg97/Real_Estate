...
namespace Real_Estate.Core.Application.Features.Accounts.Commands.RegisterAdminUser
{
    ...
    public class RegisterAdminUserCommandHandler : IRequestHandler<RegisterAdminUserCommand, 
        RegisterResponse>
    {
        ...
        public async Task<RegisterResponse> Handle(RegisterAdminUserCommand command, 
